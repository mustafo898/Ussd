...
import com.example.ussdaplication.databinding.ActivityMainBinding
        ...
        Dexter.withContext(this)
            .withPermissions(
                ...
                override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                    try {
                        App.IS_DUAL = getOperatorsName(this@MainActivity).size == 2
                        App.sharedPreference.operator = getOperatorsName(this@MainActivity)[0]
                    } catch (e: Exception) {
                        log(e.toString())
                    }
                }
